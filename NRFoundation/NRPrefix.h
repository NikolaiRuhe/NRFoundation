...
#pragma clang diagnostic ignored "-Wcstring-format-directive"
	[[NSAssertionHandler currentHandler] handleFailureInFunction:(NSString *)[NSString stringWithUTF8String:function]
															file:(NSString *)[NSString stringWithUTF8String:file]
													  lineNumber:line
